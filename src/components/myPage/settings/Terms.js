    ...
    <>
      <MaterialBox>
        ...
        <p>
          {' '}
          제 2 조 (용어의 정의)
          <br /> 본 약관에서 사용하는 용어는 다음과 같이 정의한다. ①회원 : 기본
          회원 정보를 입력하였고, 회사와 서비스 이용계약을 체결하여 아이디를
          부여받은 개인 ②아이디(ID) : 회원식별과 회원의 서비스 이용을 위해
          회원이 선정하고 회사가 승인하는 문자와 숫자의 조합 ③비밀번호(Password)
          : 회원이 통신상의 자신의 비밀을 보호하기 위해 선정한 문자와 숫자의
          조합 ④해지 : 회사 또는 회원에 의한 이용계약의 종료
        </p>
        <p>
        ...
        <p>
          ...
          사용해야 한다. 실명이나 실제 정보를 입력하지 않은 이용자는 법적인
          보호를 받을 수 없으며, 서비스 이용에 제한을 받을 수 있다.{' '}
        </p>
        <p>
          {' '}
          제 6 조 <br />
          (이용신청의 승낙) ①회사는 제5조에 따른 이용신청자에 대하여 제2항 및
          제3항의 경우를 예외로 하여 서비스 이용을 승낙한다. <br />
          ...
          다. 사회의 안녕질서 또는 미풍양속을 저해할 목적으로 신청한 경우 라.
        ...
        <p>
          ...
          항에 해당하는 경우 회사는 해당 이용자의 이용을 제한할 수 있다. <br />
          ...
          ⑦타인의 아이디 및 비밀번호를 도용한 경우 ⑧기타 관계 법령에 위배되는
        ...
        <p>
          ...
          징수하지 않는다. <br /> <br />① ‘회사’는 이용자의 구매신청이 있는 경우
        ...
        <p>
          부칙 <br />
          <br />이 약관은 2021년 3월 1일부터 시행하며, 이 약관이 제정되기 전에
          가입한 회원에게도 적용된다.
        </p>
      </MaterialBox>
    </>
