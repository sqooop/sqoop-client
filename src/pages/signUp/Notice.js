  ...
  return (
    <>
      ...
      <Wrap>
        ...
        <StyledDiv>제 1 장 총칙</StyledDiv>
        <StyledDiv>
          제 1 조 (목적) <br />본 약관은 sqoop (이하 "회사") 가 운영하는 웹
          사이트 (https://sqoop.co.kr 이하 "사이트") 의 제반 서비스의 이용조건
          및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.
        </StyledDiv>
        <StyledDiv>
          제 2 조 (용어의 정의)
          <br />
        ...
        <StyledDiv>제 2 장 이용계약</StyledDiv>
        <StyledDiv>
          제 5 조 (이용신청)
          <br />
          ...
          누르면 이용신청을 할 수 있다.
          <br />
          ②이용신청자는 반드시 실명과 실제 정보를 사용해야 한다. 실명이나 실제
          정보를 입력하지 않은 이용자는 법적인 보호를 받을 수 없으며, 서비스
          이용에 제한을 받을 수 있다.
        </StyledDiv>
        <StyledDiv>
          제 6 조 (이용신청의 승낙)
        ...
        <StyledDiv>제 3 장 계약 당사자의 의무</StyledDiv>
        <StyledDiv>
          제 7 조 (회사의 의무)
          <br />
          ...
          이용자에게 그 사유와 처리일정을 공지사항 또는 이메일을 통해 통보해야
          한다.
          <br />
        ...
        <StyledDiv>제 4 장 서비스의 제공 및 이용</StyledDiv>
        <StyledDiv>
          제 9 조 (서비스 이용)
          <br />
        ...
        <StyledDiv>
          ...
          이 메일이나 서신우편 등의 방법으로 회원에게 정보를 제공할 수 있다.
          <br />
        </StyledDiv>
        <StyledDiv>제 5 장 (재화의 주문 및 결제 관련)</StyledDiv>
        <StyledDiv>
          제16조 (결제방법)
          <br />
          ...
          있고 ‘회사’는 배송전에 이용자의 요청이 있는 경우에는 지체 없이 그
          요청에 따라 처리한다. 다만 이미 대금을 지불한 경우에는 제18조의
          ‘반품규정’을 따른다.
        </StyledDiv>
        <StyledDiv>
          제17조 (배송정책)
        ...
        <StyledDiv>부칙</StyledDiv>
        <StyledDiv>
          이 약관은 2021년 3월 1일부터 시행하며, 이 약관이 제정되기 전에 가입한
          회원에게도 적용된다.
        </StyledDiv>
        <Footer />
      </Wrap>
